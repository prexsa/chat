...
const PasswordReset = () => {
  ...
  if(isTimeExpired) {
    ...
    return (
      <NoAuthLayout heading="Password Reset" subheading="Lets update your password">
        <Box
          component="form"
          noValidate
          autoComplete="off"
        ...
        <Box sx={{ margin: '20px 0'}}>
          ...
          >
            <InputLabel htmlFor="outlined-adornment-password" sx={{ top: '-7px' }}>Re-enter Password</InputLabel>
            <OutlinedInput
            ...
            />
            <FormHelperText id="component-error-text">{dupError.hasError ? dupError.msg : ''}</FormHelperText>
          </FormControl>
