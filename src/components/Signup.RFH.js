...
const Signup = () => {
  ...
  const [passwordError, setPasswordError] = useState({ hasError: false, msg: '' });
    ...
    <NoAuthLayout heading={'Sign up'} subheading={"It's quick and easy!"}>
      ...
      >
        <Box sx={{ margin: '20px 0'}}>
          ...
          >
            <InputLabel htmlFor="outlined-adornment-password" sx={{ top: '-7px' }}>Email</InputLabel>
            <OutlinedInput
              type="text"
              size="small"
              label="Email"
        ...
        <Box sx={{ margin: '20px 0'}}>
          <FormControl 
            ...
            onFocus={onFocusHandler}
          >
            <InputLabel htmlFor="outlined-adornment-password" sx={{ top: '-7px' }}>First name</InputLabel>
            <OutlinedInput
              type="text"
              size="small"
              label="First name"
            ...
            />
            <FormHelperText id="component-error-text">{fnameError.hasError ? fnameError.msg : ''}</FormHelperText>
          </FormControl>
        </Box>
        <Box sx={{ margin: '20px 0'}}>
          <FormControl 
            ...
            onFocus={onFocusHandler}
          >
            <InputLabel htmlFor="outlined-adornment-password" sx={{ top: '-7px' }}>Last name</InputLabel>
            <OutlinedInput
              type="text"
              size="small"
              label="Last name"
            ...
            />
            <FormHelperText id="component-error-text">{lnameError.hasError ? lnameError.msg : ''}</FormHelperText>
          </FormControl>
        </Box>
        <Box sx={{ margin: '20px 0'}}>
          <FormControl 
        ...
        <Box sx={{ marginTop: '20px' }}>
          ...
          <Button variant="text" type="reset" onClick={resetHandler} fullWidth>Reset</Button>
        </Box>
      </Box>
